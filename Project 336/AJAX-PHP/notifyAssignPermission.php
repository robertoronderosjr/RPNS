 ...
 */
	...
	$message = "You have successfully assigned a permission number for - ".$courseName.":".$SectionNumber." to ".$studentName." ".$studentLastname.".";
	...
	$message = "A permission number has been successfully assigned to you for ".$courseName.":".$SectionNumber." by ".$professorName." ".$professorLastname.".";
